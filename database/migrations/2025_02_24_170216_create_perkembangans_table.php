...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('perkembangans', function (Blueprint $table) {
            ...
            $table->foreignId('id_tipe_pakan_atas')->constrained(table:'pakans', indexName:'perkembangan_id_tipe_pakan_atas_foreign')->nullable();
            $table->integer('pakan_atas');
            $table->foreignId('id_tipe_pakan_bawah')->constrained(table:'pakans', indexName:'perkembangan_id_tipe_pakan_bawah_foreign')->nullable();
