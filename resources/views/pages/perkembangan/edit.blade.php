    ...
    <section class="section p-4">
        <form action="{{ route('main.perkembangan.update', $perkembangan->hashid) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="abw_normal_atas" name="abw_normal_atas" value="{{ old('abw_normal_atas', $perkembangan->abw_normal_atas) }}">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="abw_normal_bawah" name="abw_normal_bawah" value="{{ old('abw_normal_bawah', $perkembangan->abw_normal_bawah) }}">
